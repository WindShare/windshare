...
const REQUIRED_PRODUCTION_DEPENDENCIES = [
  ...
  'web/src/output/origin-private/progressive-backend.ts',
  'web/src/output/progressive-zip/archive.ts',
  'web/src/output/progressive-zip/output.ts',
  'web/src/transfer/settlement/progressive-workspace-execution.ts',
