...
echo "-- root short atomic coverage sweep"
go test -short -count=1 -covermode=atomic -coverprofile="$root_profile" ./...
...
go -C core test -short -count=1 -covermode=atomic -coverprofile="$core_profile" ./...
