...
func TestClosedEnumRegistriesNameEveryDeclaredValue(t *testing.T) {
	tests := []struct {
		...
		{"relay recovery", int(RelayRecoveryStarted), int(RelayRecoveryWaiting), func(value int) (string, bool) { return RelayRecoveryState(value).Name() }},
		...
		{"relay lifecycle stage", int(RelayTerminalReserved), int(RelayHeartbeatFailed), func(value int) (string, bool) { return RelayLifecycleStage(value).Name() }},
		...
		{"peer phase", int(PeerPhaseNegotiation), int(PeerPhaseAdmission), func(value int) (string, bool) { return PeerAttemptPhase(value).Name() }},
		{"peer admission", int(PeerAdmissionAccepted), int(PeerAdmissionRejected), func(value int) (string, bool) { return PeerAdmissionDisposition(value).Name() }},
		{"peer response delivery", int(PeerResponseDelivered), int(PeerResponseDeliveryFailed), func(value int) (string, bool) { return PeerResponseDelivery(value).Name() }},
		{"peer lane rejection", int(PeerLaneRejectUnknownSession), int(PeerLaneRejectGrantMismatch), func(value int) (string, bool) { return PeerLaneRejectionCode(value).Name() }},
		...
		{"item block reason", int(ItemBlockNone), int(ItemBlockOwnedObjectUnknown), func(value int) (string, bool) { return ItemBlockReason(value).Name() }},
		...
		{"filesystem checkpoint decision", int(FilesystemCheckpointAbsent), int(FilesystemCheckpointInvalid), func(value int) (string, bool) { return FilesystemCheckpointDecision(value).Name() }},
		{"sender terminal send transport", int(SenderTerminalSendAccepted), int(SenderTerminalSendRetired), func(value int) (string, bool) { return SenderTerminalSendTransport(value).Name() }},
		{"sender terminal send outcome", int(SenderTerminalSendDelivered), int(SenderTerminalSendUnknown), func(value int) (string, bool) { return SenderTerminalSendOutcome(value).Name() }},
		{"sender terminal send decision", int(SenderTerminalSendDecisionDelivered), int(SenderTerminalSendFailed), func(value int) (string, bool) { return SenderTerminalSendDecision(value).Name() }},
		{"sender session terminal trigger", int(SenderSessionTerminalGracefulStop), int(SenderSessionTerminalRuntimeFailed), func(value int) (string, bool) { return SenderSessionTerminalTrigger(value).Name() }},
		{"sender session terminal provenance", int(SenderSessionTerminalNormalStop), int(SenderSessionTerminalLocalFault), func(value int) (string, bool) { return SenderSessionTerminalProvenance(value).Name() }},
