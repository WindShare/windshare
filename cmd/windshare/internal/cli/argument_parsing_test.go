...
func TestArgumentParsingNeverProjectsRejectedSecretValues(t *testing.T) {
	...
	if baselineUnknownCode != ExitUsage || !strings.HasPrefix(baselineUnknownStderr, "windshare: unknown command\nUsage:\n") {
...
func TestShareAndGetHelpAreSafeInterleavedParseOutcomes(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "share short before positional", args: []string{"share", "-h", completeLink}, wantUsage: "Usage: windshare share <path...> [options]\n"},
		{name: "share long before positional", args: []string{"share", "--help", completeLink}, wantUsage: "Usage: windshare share <path...> [options]\n"},
		{name: "share short after positional", args: []string{"share", completeLink, "-h"}, wantUsage: "Usage: windshare share <path...> [options]\n"},
		{name: "share long after positional", args: []string{"share", completeLink, "--help"}, wantUsage: "Usage: windshare share <path...> [options]\n"},
		{name: "get short before positional", args: []string{"get", "-h", completeLink}, wantUsage: "Usage: windshare get [options] <link>\n"},
		{name: "get long before positional", args: []string{"get", "--help", completeLink}, wantUsage: "Usage: windshare get [options] <link>\n"},
		{name: "get short after positional", args: []string{"get", completeLink, "-h"}, wantUsage: "Usage: windshare get [options] <link>\n"},
		{name: "get long after positional", args: []string{"get", completeLink, "--help"}, wantUsage: "Usage: windshare get [options] <link>\n"},
	}
