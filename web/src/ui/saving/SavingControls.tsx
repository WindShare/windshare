  ...
  return <section className="saving-controls" aria-label="Download action"
    ...
    {activation !== null ? <div className="preparing-task">
      ...
      <div className="saving-primary-row">
        ...
        {model.alternatives.length > 0 && <button className="quiet-action" type="button" onClick={() => { onIntent('open-saving-alternatives'); setAlternatives(true) }}>Other ways to save<ReceiverIcon name="chevron-right" /></button>}
