...
import type { ICEEndpointPool, AttemptICEProfile } from '../ice-policy/endpoints'
import type { PeerProviderFact } from './provider-facts'
import type { PeerNetworkGeneration } from './network-generation'
import type { PeerTabAdmission } from './tab-admission'
import type {
...
export const V2_PEER_SIGNALING_BUDGET_MILLISECONDS = 10_000
export const V2_PEER_ICE_CHECK_BUDGET_MILLISECONDS = 40_000
export const V2_PEER_DTLS_BUDGET_MILLISECONDS = 15_000
export const V2_PEER_ATTEMPT_BUDGET_MILLISECONDS = 85_000
export const V2_PEER_BUDGET_REFILL_MILLISECONDS = 600_000
export const V2_PEER_BROWSE_RETENTION_MILLISECONDS = 30_000
export const V2_DEFAULT_PEER_NEGOTIATION_BUDGET_MILLISECONDS = 65_000
...
export interface V2PeerAttemptContext {
  readonly admissionWaitBudgetMilliseconds?: number
  readonly iceProfile?: AttemptICEProfile
  readonly observeICEFact?: (fact: PeerProviderFact) => void
...
export interface V2PeerRecoveryDependencies {
  ...
  readonly endpoints?: ICEEndpointPool
...
export interface V2PeerRecoverySupervisorOptions {
  ...
  readonly endpoints?: ICEEndpointPool
  readonly budget?: PeerAttemptBudget
  readonly releaseLane?: (lane: V2PeerAdmittedLane) => void
  readonly protocolSessionId: V2ProtocolSessionIdentity
  readonly peerPathId: V2PeerPathIdentity
