...
export const DESTINATION_RESERVATION_DOMAIN = 'windshare/destination-reservation/v4'
...
export const MATERIALIZATION_PLAN_DOMAIN = 'windshare/materialization-plan/v4'
export const RECEIVE_INTENT_DOMAIN = 'windshare/receive-intent/v4'
