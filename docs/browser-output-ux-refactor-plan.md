...
> 状态：**2026-08-09 已实现。** 当前生产合同与诚实恢复边界见 [`协议规范.md`](协议规范.md)、
> [`威胁模型.md`](威胁模型.md) 和 [`即时分享与文件浏览产品澄清.md`](clarifications/即时分享与文件浏览产品澄清.md)。本专项承接
> [`即时分享与文件浏览重构收尾计划.md`](.archive/2026.08.06/即时分享与文件浏览重构收尾计划.md)，保留原始需求与裁决供追溯，不再作为待办入口。
