...
- **Direct ZIP:** automatic checkpoints continue as the archive grows, with increasing intervals to limit repeated copying. The unsaved portion can grow too; **Details** shows the actual restart-safe progress. Pausing saves current progress. Continuing after a checkpoint may copy the saved prefix and require comparable extra destination space.
