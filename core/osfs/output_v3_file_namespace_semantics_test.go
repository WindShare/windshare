...
func TestScanOutputV3FileNamespaceRejectsInvalidOwnershipAndNamespaceRaces(t *testing.T) {
	...
	t.Run("list-failure", func(t *testing.T) {
		...
		opened.Session.filesDir = &outputV3NamespaceNamesDirectory{
			outputV3Directory: opened.Session.filesDir,
			namesErr:          failure,
		}
		_, err := scanOutputV3FileNamespace(opened.Session)
...
func TestScanOutputV3FileNamespaceFailsClosedAtEveryPinnedShardCut(t *testing.T) {
	...
	for _, test := range []struct {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			session.filesDir = &outputV3NamespaceFaultDirectory{outputV3Directory: original, faults: &faults}
...
func (directory *outputV3NamespaceFaultDirectory) ClassifyExactEntry(name string) (outputV3EntryKind, bool, error) {
...
func (directory *outputV3NamespaceFaultDirectory) OpenDirectory(name string, private bool) (outputV3Directory, error) {
	...
	return &outputV3NamespaceFaultDirectory{outputV3Directory: opened, faults: directory.faults, child: true}, nil
}

func (directory *outputV3NamespaceFaultDirectory) SameDirectory(other outputV3Directory) (bool, error) {
...
func (directory *outputV3NamespaceFaultDirectory) CreateFile(name string, private bool, size int64) (outputV3File, error) {
...
func (directory *outputV3NamespaceMutationShard) SameDirectory(other outputV3Directory) (bool, error) {
