...
import (
	...
	"github.com/windshare/windshare/core/osfs/internal/outputprobe"
...
func (root *windowsV3Directory) inspectOutputProbeLeftover(name string) (*windowsV3OutputProbeLeftover, error) {
	...
	var observation outputprobe.Observation
	...
	if err := outputprobe.Validate(outputprobe.WindowsNTFS, observation); err != nil {
		return fail(err)
	}
	return leftover, nil
}
