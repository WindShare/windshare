...
func (platform *outputV3PublicationPermissionPlatform) Root() outputV3Directory {
...
func (directory *outputV3PublicationPermissionDirectory) Duplicate() (outputV3Directory, error) {
...
func (directory *outputV3PublicationPermissionDirectory) SameDirectory(other outputV3Directory) (bool, error) {
...
func v3RecoveryPublicationPermissionAuthority(
	...
	authority.platformFactory = func(path string, create bool) (outputV3Platform, error) {
		...
		return &outputV3PublicationPermissionPlatform{outputV3Platform: platform, gate: gate}, nil
	}
	return authority
}
