...
func buildArtifactChoiceVectorCases(t *testing.T) []any {
	...
	cases := []choiceCase{
		...
		{"zip-workspace-managed", receivecontract.ArtifactZipArchive, receivecontract.PlanWorkspaceThenPublish, receivecontract.GuaranteeManagedAtomic, receivecontract.PreparationNone, "available"},
		{"zip-workspace-handoff", receivecontract.ArtifactZipArchive, receivecontract.PlanWorkspaceThenPublish, receivecontract.GuaranteeBrowserHandoff, receivecontract.PreparationNone, "available"},
